...
function Profile() {
  ...
  async function gettinguserTweetLength() {
    await fetch(`http://127.0.0.1:5000/posts/user_profile/${userIdPass}`)
  ...
  async function settingUsername() {
    await fetch(`http://127.0.0.1:5000/auth/${userIdPass}`)
      .then(response => response.json())
      .then(response => {
        ...
        <div className="mx-3 mt-3 menu_and_follow_btn" style={{ float: "right" }}>
          <span>
            ...
            <div className="mx-3 mt-3 menu_and_follow_btn" style={{ float: "right" }}>
              <span>
                {/* <Link href="/"> */}
                {/* <a style={{ textDecoration: "none" }} className="mx-2"> */}
                <span className="mx-2" style={{ cursor: "pointer" }}>
                  <span className='LightScrnMenu'><img src={MoreMenuWhite.src} alt="#imgNotFound" width="30px" height="30px" style={{ marginTop: "-10px" }} /></span>
                  <span className='DarkScrnMenu'><img src={MoreMenuBlack.src} alt="#imgNotFound" width="30px" height="30px" style={{ marginTop: "-10px" }} /></span>
                </span>
                {/* </a> */}
                {/* </Link> */}
              </span>
              <button type="button" className="btn follow_btn" style={{ borderRadius: "20px", marginTop: "-8px" }}><b>Follow</b></button>
            </div>
          </span>
        </div>
      </div>
